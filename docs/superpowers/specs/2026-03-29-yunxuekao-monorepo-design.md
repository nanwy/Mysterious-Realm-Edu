...
- 首页当前已参考新的视觉稿重构为“浅雾蓝科技教育风”：头部加入轻量搜索框，首屏改为双栏 Hero，右侧为学习总览面板，首页语义统一切回中文教育词汇
- 首页核心信息重新编排为“学习总览 + 教务通知/快捷入口 + 近期考试安排 + 问卷与资讯 + 底部 CTA”，在保留课程、考试、资讯、问卷等重要数据分区的同时，更接近现代教育平台产品首页的视觉节奏
- 已进一步压缩首屏文案密度，缩短主标题和说明文字；右侧学习总览卡去掉外凸悬浮块，改为卡片内部摘要信息，边框层级也更克制
- 已重新整理第二屏和第三屏布局：第二屏采用“课程主卡 + 教务侧栏”，第三屏采用“资讯主区 + 热点/问卷侧栏”，避免上一版出现的大面积留白和列宽失衡
- 已将最后一屏右侧的“热点追踪 / 问卷与调研”统一改为更紧凑的侧栏任务模块，其中问卷卡片缩短为轻量任务卡，避免右下区域头重脚轻
